...
public class MyClient {
    ...
    private static final String FLOW_NAME = "Patient-" + RANDOM_UUID.toString();
    private static final String BUCKET_NAME = "populationanalytics";
    private static final String S3N_HADOOP_JAR =
            "s3n://" + BUCKET_NAME + "/job/MapReduce-SNAPSHOT.jar";
    private static final String S3N_LOG_URI = "s3n://" + BUCKET_NAME + "/log/";
    //private static final String JOB_ARGS = new String("s3n://" + BUCKET_NAME + "/result/" + FLOW_NAME);
